...
import project5 from "@/assets/p1.png";
import project6 from "@/assets/p2.png";
import project7 from "@/assets/p3.png";
import project8 from "@/assets/p4.png";
import project9 from "@/assets/p5.png";
import project10 from "@/assets/p6.png";
import project11 from "@/assets/p7.png";
import project12 from "@/assets/p8.png";
...
const projects = [
  ...
  },
  {
    ...
    description:
      "A modern hotel booking system featuring real-time room availability, online reservations, an admin dashboard for room and booking management, and secure GCash and Maya payment integration for a seamless user experience.",
    // 👉 MULTIPLE IMAGES HERE
    images: [project5,project7,project6,project8,project9,project10,project11,project12],
    tags: ["React", "TypeScript", "JavaScript","PHP"],
    github: "https://github.com/iamSKRT/HOTEL-ROOM-BOOKING-SYSTEM",
    demo: "",
  },
];
