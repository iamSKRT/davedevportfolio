  ...
  import { Github, Instagram, Linkedin, ArrowDown, Download } from "lucide-react";

  const roleText = "UI/UX Developer";
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start mb-8">
              ...
              >
                ...
                <p className="text-muted-foreground/100 mb-6 sm:mb-10 leading-relaxed text-sm sm:text-base">
                   Hello! I'm Christian Dave D. Alvarez, a UI/UX Developer and a graduate of the Bachelor of Science in Information Technology program at Our Lady of Fatima University (Antipolo Campus).
                   I am passionate about developing user-friendly websites and creating clean, intuitive, and visually appealing user interfaces. Behind every error solved, 
                ...
                <div className="flex items-center gap-4 flex-wrap mb-4">
                  <a
                    href="#contact"
                    className="px-6 sm:px-6 py-2.5 sm:py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold text-sm sm:text-base hover:opacity-90 transition-opacity glow"
                  >
                    Get in Touch
                  </a>
                  ...
                  <a
                    href="/resume.pdf"
                    download="Christian_Dave_Resume.pdf"
                    className="px-6 sm:px-4 py-2.5 sm:py-3.5 rounded-xl bg-secondary border border-border text-secondary-foreground font-semibold text-sm sm:text-base hover:border-primary/30 transition-all flex items-center gap-2"
                  >
                    <Download size={18} />
                    Download Resume
                  </a>
                ...
                <div className="flex items-center gap-4 mt-2">
                  <a
                    ...
                    className="w-10 h-10 sm:w-11 sm:h-11 rounded-lg bg-secondary/50 flex items-center justify-center text-muted-foreground hover:text-white hover:scale-110 transition-all duration-300 border border-border"
                  >
                    <Github size={18} />
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 sm:w-11 sm:h-11 rounded-lg bg-secondary/50 flex items-center justify-center text-muted-foreground hover:text-[#0A66C2] hover:scale-110 transition-all duration-300 border border-border"
                  >
                    <Linkedin size={18} />
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 sm:w-11 sm:h-11 rounded-lg bg-secondary/50 flex items-center justify-center text-muted-foreground hover:text-[#E4405F] hover:scale-110 transition-all duration-300 border border-border"
                  >
                    <Instagram size={18} />
                  </a>
                </div>
